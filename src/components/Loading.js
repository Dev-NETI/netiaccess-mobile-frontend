...
function Loading({label}) {
    return (
        <div className="flex flex-col items-center justify-center w-56 h-72 border bg-cyan-400
        border-gray-200 rounded-lg  dark:bg-gray-800 dark:border-gray-700">
            <div className='basis-full mt-48'>
                <svg aria-hidden="true" className="w-8 h-8 text-cyan-900 animate-spin dark:text-gray-600 fill-blue-600" viewBox="0 0 100 101" fill="none"
            ...
            <p className='basis-full float-center'>{label}</p>
        </div>
    )
}
